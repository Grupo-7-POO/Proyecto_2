...
public class CrearTarea extends JFrame implements ActionListener 
{
	 ...
	 * Create the frame.
	 */
	public CrearTarea( Profesor profesor ) 
	{
		...
		btnNewButton_1 = new JButton("Generar Tarea");
		...
		JLabel lblNewLabel_8_3 = new JLabel("Motivo de Entrega:");
		lblNewLabel_8_3.setBounds(10, 211, 142, 14);
		contentPane.add(lblNewLabel_8_3);
		
		textField_7 = new JTextField();
		textField_7.setColumns(10);
		textField_7.setBounds(10, 236, 237, 55);
